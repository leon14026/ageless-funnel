...
// Inlined from _shared/http.ts + _shared/catalog.ts so this function is self-contained
// and can be deployed by pasting this single file into the Supabase dashboard.
const corsHeaders = {
...
// Server-authoritative prices: the client can never set an amount.
...
function validateItems(skus: unknown, allowAddons: boolean) {
